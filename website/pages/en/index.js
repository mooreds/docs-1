  ...
  render() {
    ...
    const Logo = props => (
      <div className="projectLogo">
        <img src={props.img_src} alt="Transposit" />
      </div>
    );
    ...
    return (
      <SplashContainer>
        ...
        <p><iframe width="560" height="315" src="https://www.youtube.com/embed/VLvjSh1fkp0" frameBorder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowFullScreen={true}></iframe></p>
      </SplashContainer>
    );
  }
}
    ...
    const Features = () => (
      <Block layout="fourColumn">
        {[
          ...
          {
            content: 'We\'d love to hear from you if you have feedback about our product or documentation, or if you build something awesome you\'d like to share. Email us at support@transposit.com.',
            title: 'Get in touch',
          },
        ]}
      </Block>
